...
@WebServlet(urlPatterns = {"/common/product/loadAjax"})
public class ProductLoadAjaxController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String skipAmount = req.getParameter("currProductsCount");
		String orderBy = req.getParameter("orderBy");
		String isLogin = req.getParameter("isLogin");
		int skipAmountInt = Integer.parseInt(skipAmount);
		List<ProductModel> nextNineProducts= productServicesImpl.loadNextNine(orderBy, skipAmountInt);
		PrintWriter out = resp.getWriter();
		for (ProductModel product : nextNineProducts) {
